...
package gsl.rng is
   ...
   type gsl_rng_type is record
      ...
      size : aliased size_t;  -- /usr/include/gsl/gsl_rng.h:44
   ...
   function gsl_rng_fread (stream : access ICS.FILEs; r : access gsl_rng) return int  -- /usr/include/gsl/gsl_rng.h:141
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_rng_fread";

   function gsl_rng_fwrite (stream : access ICS.FILEs; r : access constant gsl_rng) return int  -- /usr/include/gsl/gsl_rng.h:142
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_rng_fwrite";

   function gsl_rng_size (r : access constant gsl_rng) return size_t  -- /usr/include/gsl/gsl_rng.h:144
   with Import => True, 
        Convention => C, 
