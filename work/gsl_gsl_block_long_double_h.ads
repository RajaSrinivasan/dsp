...
package gsl_gsl_block_long_double_h is
   ...
   function gsl_block_long_double_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; b : access gsl_block_long_double) return int  -- /usr/include/gsl/gsl_block_long_double.h:50
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_long_double_fread";

   function gsl_block_long_double_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; b : access constant gsl_block_long_double) return int  -- /usr/include/gsl/gsl_block_long_double.h:51
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_block_long_double_fwrite";

   function gsl_block_long_double_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; b : access gsl_block_long_double) return int  -- /usr/include/gsl/gsl_block_long_double.h:52
   with Import => True, 
        Convention => C, 
   ...
   function gsl_block_long_double_raw_fread
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      ...
      n : stddef_h.size_t;
      stride : stddef_h.size_t) return int  -- /usr/include/gsl/gsl_block_long_double.h:55
   with Import => True, 
        Convention => C, 
   ...
   function gsl_block_long_double_raw_fwrite
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      b : access long_double;
      n : stddef_h.size_t;
      stride : stddef_h.size_t) return int  -- /usr/include/gsl/gsl_block_long_double.h:56
   with Import => True, 
        Convention => C, 
   ...
   function gsl_block_long_double_raw_fscanf
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      b : access long_double;
      n : stddef_h.size_t;
      stride : stddef_h.size_t) return int  -- /usr/include/gsl/gsl_block_long_double.h:57
   with Import => True, 
        Convention => C, 
