...
package gsl_gsl_cblas_h is
   ...
   CblasRowMajor : constant CBLAS_ORDER := 101;
   CblasColMajor : constant CBLAS_ORDER := 102;  -- /usr/include/gsl/gsl_cblas.h:46

   subtype CBLAS_TRANSPOSE is unsigned;
   CblasNoTrans : constant CBLAS_TRANSPOSE := 111;
   CblasTrans : constant CBLAS_TRANSPOSE := 112;
   CblasConjTrans : constant CBLAS_TRANSPOSE := 113;  -- /usr/include/gsl/gsl_cblas.h:47

   subtype CBLAS_UPLO is unsigned;
   CblasUpper : constant CBLAS_UPLO := 121;
   CblasLower : constant CBLAS_UPLO := 122;  -- /usr/include/gsl/gsl_cblas.h:48

   subtype CBLAS_DIAG is unsigned;
   CblasNonUnit : constant CBLAS_DIAG := 131;
   CblasUnit : constant CBLAS_DIAG := 132;  -- /usr/include/gsl/gsl_cblas.h:49

   subtype CBLAS_SIDE is unsigned;
   CblasLeft : constant CBLAS_SIDE := 141;
   CblasRight : constant CBLAS_SIDE := 142;  -- /usr/include/gsl/gsl_cblas.h:50
