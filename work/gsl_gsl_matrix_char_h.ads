...
package gsl_gsl_matrix_char_h is
   ...
   type gsl_matrix_char is record
      ...
      block : access gsl_gsl_block_char_h.gsl_block_char;  -- /usr/include/gsl/gsl_matrix_char.h:49
   ...
   function gsl_matrix_char_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_char) return int  -- /usr/include/gsl/gsl_matrix_char.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_char_fread";

   function gsl_matrix_char_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access constant gsl_matrix_char) return int  -- /usr/include/gsl/gsl_matrix_char.h:214
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_char_fwrite";

   function gsl_matrix_char_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_char) return int  -- /usr/include/gsl/gsl_matrix_char.h:215
   with Import => True, 
        Convention => C, 
   ...
   function gsl_matrix_char_fprintf
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      m : access constant gsl_matrix_char;
      format : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/gsl/gsl_matrix_char.h:216
   with Import => True, 
        Convention => C, 
