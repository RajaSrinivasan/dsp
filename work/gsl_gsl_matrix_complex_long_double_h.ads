...
package gsl_gsl_matrix_complex_long_double_h is
   ...
   --  skipped anonymous struct anon_anon_89
   ...
   type gsl_matrix_complex_long_double is record
      ...
      block : access gsl_gsl_block_complex_long_double_h.gsl_block_complex_long_double;  -- /usr/include/gsl/gsl_matrix_complex_long_double.h:49
   ...
   --  skipped anonymous struct anon_anon_90
   ...
   --  skipped anonymous struct anon_anon_91
   ...
   function gsl_matrix_complex_long_double_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_complex_long_double) return int  -- /usr/include/gsl/gsl_matrix_complex_long_double.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_complex_long_double_fread";

   function gsl_matrix_complex_long_double_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access constant gsl_matrix_complex_long_double) return int  -- /usr/include/gsl/gsl_matrix_complex_long_double.h:214
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_complex_long_double_fwrite";

   function gsl_matrix_complex_long_double_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_complex_long_double) return int  -- /usr/include/gsl/gsl_matrix_complex_long_double.h:215
   with Import => True, 
        Convention => C, 
   ...
   function gsl_matrix_complex_long_double_fprintf
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      m : access constant gsl_matrix_complex_long_double;
      format : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/gsl/gsl_matrix_complex_long_double.h:216
   with Import => True, 
        Convention => C, 
