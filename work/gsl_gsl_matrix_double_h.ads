...
package gsl_gsl_matrix_double_h is
   ...
   type gsl_matrix is record
      ...
      block : access gsl_gsl_block_double_h.gsl_block;  -- /usr/include/gsl/gsl_matrix_double.h:49
   ...
   function gsl_matrix_alloc_from_block
     (b : access gsl_gsl_block_double_h.gsl_block;
   ...
   function gsl_matrix_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix) return int  -- /usr/include/gsl/gsl_matrix_double.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_fread";

   function gsl_matrix_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access constant gsl_matrix) return int  -- /usr/include/gsl/gsl_matrix_double.h:214
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_fwrite";

   function gsl_matrix_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix) return int  -- /usr/include/gsl/gsl_matrix_double.h:215
   with Import => True, 
        Convention => C, 
   ...
   function gsl_matrix_fprintf
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      m : access constant gsl_matrix;
      format : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/gsl/gsl_matrix_double.h:216
   with Import => True, 
        Convention => C, 
