...
package gsl_gsl_matrix_int_h is
   ...
   type gsl_matrix_int is record
      ...
      block : access gsl_gsl_block_int_h.gsl_block_int;  -- /usr/include/gsl/gsl_matrix_int.h:49
   ...
   function gsl_matrix_int_alloc_from_block
     (b : access gsl_gsl_block_int_h.gsl_block_int;
   ...
   function gsl_matrix_int_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_int) return int  -- /usr/include/gsl/gsl_matrix_int.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_int_fread";

   function gsl_matrix_int_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access constant gsl_matrix_int) return int  -- /usr/include/gsl/gsl_matrix_int.h:214
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_int_fwrite";

   function gsl_matrix_int_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_int) return int  -- /usr/include/gsl/gsl_matrix_int.h:215
   with Import => True, 
        Convention => C, 
   ...
   function gsl_matrix_int_fprintf
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      m : access constant gsl_matrix_int;
      format : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/gsl/gsl_matrix_int.h:216
   with Import => True, 
        Convention => C, 
