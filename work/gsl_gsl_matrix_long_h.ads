...
package gsl_gsl_matrix_long_h is
   ...
   type gsl_matrix_long is record
      ...
      block : access gsl_gsl_block_long_h.gsl_block_long;  -- /usr/include/gsl/gsl_matrix_long.h:49
   ...
   function gsl_matrix_long_alloc_from_block
     (b : access gsl_gsl_block_long_h.gsl_block_long;
   ...
   function gsl_matrix_long_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_long) return int  -- /usr/include/gsl/gsl_matrix_long.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_long_fread";

   function gsl_matrix_long_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access constant gsl_matrix_long) return int  -- /usr/include/gsl/gsl_matrix_long.h:214
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_long_fwrite";

   function gsl_matrix_long_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_long) return int  -- /usr/include/gsl/gsl_matrix_long.h:215
   with Import => True, 
        Convention => C, 
   ...
   function gsl_matrix_long_fprintf
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      m : access constant gsl_matrix_long;
      format : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/gsl/gsl_matrix_long.h:216
   with Import => True, 
        Convention => C, 
