...
package gsl_gsl_matrix_ulong_h is
   ...
   type gsl_matrix_ulong is record
      ...
      block : access gsl_gsl_block_ulong_h.gsl_block_ulong;  -- /usr/include/gsl/gsl_matrix_ulong.h:49
   ...
   function gsl_matrix_ulong_alloc_from_block
     (b : access gsl_gsl_block_ulong_h.gsl_block_ulong;
   ...
   function gsl_matrix_ulong_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_ulong) return int  -- /usr/include/gsl/gsl_matrix_ulong.h:213
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_ulong_fread";

   function gsl_matrix_ulong_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access constant gsl_matrix_ulong) return int  -- /usr/include/gsl/gsl_matrix_ulong.h:214
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_matrix_ulong_fwrite";

   function gsl_matrix_ulong_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; m : access gsl_matrix_ulong) return int  -- /usr/include/gsl/gsl_matrix_ulong.h:215
   with Import => True, 
        Convention => C, 
   ...
   function gsl_matrix_ulong_fprintf
     (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE;
      m : access constant gsl_matrix_ulong;
      format : Interfaces.C.Strings.chars_ptr) return int  -- /usr/include/gsl/gsl_matrix_ulong.h:216
   with Import => True, 
        Convention => C, 
