...
package gsl_gsl_vector_double_h is
   ...
   type gsl_vector is record
      ...
      block : access gsl_gsl_block_double_h.gsl_block;  -- /usr/include/gsl/gsl_vector_double.h:47
   ...
   function gsl_vector_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector) return int  -- /usr/include/gsl/gsl_vector_double.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_fread";

   function gsl_vector_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access constant gsl_vector) return int  -- /usr/include/gsl/gsl_vector_double.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_fwrite";

   function gsl_vector_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector) return int  -- /usr/include/gsl/gsl_vector_double.h:132
   with Import => True, 
        Convention => C, 
