...
package gsl_gsl_vector_int_h is
   ...
   type gsl_vector_int is record
      ...
      block : access gsl_gsl_block_int_h.gsl_block_int;  -- /usr/include/gsl/gsl_vector_int.h:47
   ...
   function gsl_vector_int_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_int) return int  -- /usr/include/gsl/gsl_vector_int.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_int_fread";

   function gsl_vector_int_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access constant gsl_vector_int) return int  -- /usr/include/gsl/gsl_vector_int.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_int_fwrite";

   function gsl_vector_int_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_int) return int  -- /usr/include/gsl/gsl_vector_int.h:132
   with Import => True, 
        Convention => C, 
