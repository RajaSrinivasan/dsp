...
package gsl_gsl_vector_long_h is
   ...
   type gsl_vector_long is record
      ...
      block : access gsl_gsl_block_long_h.gsl_block_long;  -- /usr/include/gsl/gsl_vector_long.h:47
   ...
   function gsl_vector_long_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_fread";

   function gsl_vector_long_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access constant gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_long_fwrite";

   function gsl_vector_long_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_long) return int  -- /usr/include/gsl/gsl_vector_long.h:132
   with Import => True, 
        Convention => C, 
