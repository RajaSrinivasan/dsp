...
package gsl_gsl_vector_short_h is
   ...
   type gsl_vector_short is record
      ...
      block : access gsl_gsl_block_short_h.gsl_block_short;  -- /usr/include/gsl/gsl_vector_short.h:47
   ...
   function gsl_vector_short_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_short) return int  -- /usr/include/gsl/gsl_vector_short.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_short_fread";

   function gsl_vector_short_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access constant gsl_vector_short) return int  -- /usr/include/gsl/gsl_vector_short.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_short_fwrite";

   function gsl_vector_short_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_short) return int  -- /usr/include/gsl/gsl_vector_short.h:132
   with Import => True, 
        Convention => C, 
