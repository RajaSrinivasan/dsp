...
package gsl_gsl_vector_ulong_h is
   ...
   type gsl_vector_ulong is record
      ...
      block : access gsl_gsl_block_ulong_h.gsl_block_ulong;  -- /usr/include/gsl/gsl_vector_ulong.h:47
   ...
   function gsl_vector_ulong_fread (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_ulong) return int  -- /usr/include/gsl/gsl_vector_ulong.h:130
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_ulong_fread";

   function gsl_vector_ulong_fwrite (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access constant gsl_vector_ulong) return int  -- /usr/include/gsl/gsl_vector_ulong.h:131
   with Import => True, 
        Convention => C, 
        External_Name => "gsl_vector_ulong_fwrite";

   function gsl_vector_ulong_fscanf (stream : access aarch64_linux_gnu_bits_types_FILE_h.FILE; v : access gsl_vector_ulong) return int  -- /usr/include/gsl/gsl_vector_ulong.h:132
   with Import => True, 
        Convention => C, 
